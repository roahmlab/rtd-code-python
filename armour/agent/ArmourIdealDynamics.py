...
from armour.agent import ArmourAgentInfo, ArmourAgentState, ArmourIdealController
...
class ArmourIdealDynamics(BaseDynamicsComponent, Options):
    '''
    ...
    def __init__(self, arm_info: ArmourAgentInfo, arm_state: ArmourAgentState, 
                 arm_controller: ArmourIdealController, **options):
        ...
        self.controller: ArmourIdealController = arm_controller
    ...
    def move(self, t_move: float):
        ...
        target = self.controller.getControlInputs(t_meas) # t_meas + t_cur
